  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if(data.success===false){
        setLoading(false);
        // console.log(data); fix  sign up fail user or email already exixt
    ...
    <div className='min-h-screen mt-12' >
      <div className='flex p-6 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5'>
        ...
        <div className='flex-1 flex flex-col items-center justify-center'>
          <Link to='/' className=' text-4xl font-bold dark:text-white r' ><span className='px-2 py-1 bg-gradient-to-r from-blue-200 via-cyan-500 to-blue-700 text-white rounded-md'>Jeca</span>Cracker</Link>
